    ...
    <Tabs defaultValue="dashboard" className="w-full">
      ...
      <TabsContent value="dashboard" className="mt-0">
        <div className="grid grid-cols-1 gap-6">
          ...
          {/* AI Training System - Primary focus for progression */}
          <ComputePanel 
            gameState={gameState}
            trainModel={trainModel}
          />
          
          {/* System Status Panel - Strategic compute resource management */}
          <SystemStatusPanel gameState={gameState} />

          {/* Resource Flow Visualization - Visual understanding of system dynamics */}
          <div>
            <h3 className="text-lg font-medium mb-4 flex items-center">
              <NetworkIcon className="h-5 w-5 mr-2 text-amber-400" />
